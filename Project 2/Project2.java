...
public class Project2 {
	...
	static Semaphore receptionistAvailable = new Semaphore(1, true);
	static Semaphore receptionistTakesPatient = new Semaphore(0, true);
	...
	public static class Patient extends Person implements Runnable
	{
		...
		public void run()
		{
			try
			{
				...
				receptionistTakesPatient.release();
		...
		public void run()
		{
			try
			{
				while (true)
				{
					...
					receptionistTakesPatient.acquire();
					print("Receptionist registers patient "+currentPatientToRegister);
